...
export function LabLayout() {
  ...
  const [activeId, setActiveId] = useState<AlgorithmId>(() =>
    isAlgorithmId(routeId ?? "") ? (routeId as AlgorithmId) : DEFAULT_ALGORITHM_ID,
  );
            ...
            <div className="relative flex items-stretch">
              ...
              <div
                ...
                style={{
                  ...
                  left: indicator.left,
                  transition: "left cubic-bezier(.88, -.35, .565, 1.35) 0.4s, width cubic-bezier(.88, -.35, .565, 1.35) 0.4s",
